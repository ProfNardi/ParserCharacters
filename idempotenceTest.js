...
assertIdempotent(`Green Lantern [John Stewart]; Justice League [Superman [Clark Kent; Kal-El]; Batman [Bruce Wayne]]; Jimmy Olsen (origin, death)`);
assertIdempotent(`Batman; Superman (death); Flash [Barry Allen]`);
assertIdempotent(`Justice League [Superman; Batman; Wonder Woman]`);
assertIdempotent(`Foo (a; b; c); Bar [x; y; z]`);
